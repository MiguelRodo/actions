...
Copy [`examples/prebuild-devcontainer.yml`](../examples/prebuild-devcontainer.yml) into `.github/workflows/prebuild-devcontainer.yml`. It supports tag-triggered builds plus manual `version` or `bump_type` releases.
