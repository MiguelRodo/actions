---
title: "Prune APT Repository"
---

<!-- generated-from-action-readme -->
<!-- This page is generated from apt-repo-prune/README.md. -->
...
The action is designed for repositories that are managed by the [go-version-release](go-version-release.qmd) action in this repository; it validates the expected `pool/main/` and `dists/stable/` structure before proceeding.
