  ...
  release:
    ...
    steps:
      - uses: actions/checkout@v4
        with:
          fetch-depth: 0
      - uses: MiguelRodo/actions/rust-version-release@v3
        with:
...
<!-- action-inputs:start -->
<!-- Generated from rust-version-release/action.yml by scripts/generate-action-docs.py. Do not edit this block manually. -->
## Inputs
